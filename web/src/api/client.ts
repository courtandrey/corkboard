...
export type ClusterPin = components["schemas"]["ClusterPin"];
export type ClusterBounds = components["schemas"]["ClusterBounds"];
...
export type PlaceSuggestions = components["schemas"]["PlaceSuggestions"];
export type ConnectionsResponse = components["schemas"]["ConnectionsResponse"];
export type ConnectionItem = components["schemas"]["ConnectionItem"];
