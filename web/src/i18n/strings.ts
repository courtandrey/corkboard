export const strings = {
  ...
  verify: {
    ...
    gateReason: {
      ...
      connect: "Asking to connect needs a confirmed email.",
    },
  },
  scope: {
    ...
    emptySubscriptions: "Nothing here yet — this is where the boards people share with you turn up.",
    noSubscriptions: "Nobody shares their board with you yet. Connect with a neighbour and ask.",
    peopleTitle: "Whose boards",
    chip: "Yours",
  ...
  notificationsUi: {
    ...
    connectionRequested: (name: string) => `${name} would like to connect`,
  ...
  connections: {
    ...
    searchPlaceholder: "find someone by user ID or name…",
    clear: "Clear the search",
    found: "People",
    nobody: "Nobody by that name or ID.",
    yours: "Connected",
    incoming: "Asking to connect",
    outgoing: "Requested",
    empty: "No connections yet. Search above to find someone.",
    connect: "Connect",
    accept: "Accept",
    dismiss: "Dismiss",
    asked: "Pending",
